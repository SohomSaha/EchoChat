        ...
        <div className="bg-base-300 p-6 space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 text-base-content/100 rounded-lg border">
                {authUser?.fullName}
              </p>
            </div>
            <div className="space-y-1.5">
          ...
          <div className="mt-6 bg-base-300 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex text-base-content items-center justify-between py-2 border-b border-zinc-700">
